/**
 * Hand-drawn 24×24 stroke icons, lucide-style. Single accent stroke so the
 * vermilion accent stays reserved for evidence and verdicts.
 */
...
const PATHS = {
  ...
  phonecall: (
    <>
      <path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3.1 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.1 4.2 2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1 1 .4 2 .7 2.8a2 2 0 0 1-.5 2.1L8.1 9.9a16 16 0 0 0 6 6l1.3-1.3a2 2 0 0 1 2.1-.4c.9.3 1.9.5 2.8.7a2 2 0 0 1 1.7 2z" />
      <path d="M14 4c1.5.4 2.7 1.3 3.5 2.5M17.5 2.5c1 .6 1.9 1.5 2.5 2.5" />
    </>
  ),
  sun: (
    <>
...
/** Brand mark: a ring holding a dot — the coin held, the signal, the risk dot. */
export function LogoMark({ className = 'h-5 w-5' }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true">
      <circle cx="12" cy="12" r="9.5" fill="none" stroke="currentColor" strokeWidth="1.5" />
      <circle cx="12" cy="12" r="3" fill="var(--color-vermilion)" />
    </svg>
  )
}
